            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">{{ 'Rp '. number_format($data['product']->price, 0, ',', '.') }} <span></div>
                            <h6>Sisa Stok : <span>{{ $data['product']->qty }}</span></h6>
                        @csrf
                        <div class="product__details__button">
                            <div class="quantity">
                                <span>Jumlah:</span>
                                <div class="inline-flex items-center rounded-md shadow-sm">
                                    <input type="number" name="cart_qty" value="1" min="0" max="{{ $data['product']->qty }}" class="w-16 px-2 py-1 text-sm leading-5 appearance-none bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 rounded-md">
                                </div>
