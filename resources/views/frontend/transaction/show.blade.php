                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="invoice-title">
                                        ...
                                        <div class="invoice-number1" hidden>{{ $data['order']->invoice_number }}</div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-6">
    ...
    <script>
        ...
        payButton.addEventListener('click', function(e) {
            ...
            snap.pay('{{ $data['order']->snap_token }}', {
                ...
                var invoiceNumber = document.querySelector('.invoice-number1').innerText.trim();

                var xhr = new XMLHttpRequest();
                    xhr.open('POST', '{{ route('transaction.update') }}', true);
                    ...
                    var params = 'invoiceNumber=' + encodeURIComponent(invoiceNumber) + '&status=1';
                    xhr.send(params);
